...
"    channel.innerHTML = channel.innerHTML + \"</br>\";\n"
"    channel.innerHTML = channel.innerHTML + \"Channel\" + n;\n"
"    channel.innerHTML = channel.innerHTML + \"<hr width=50%>\";\n"
"    channel.innerHTML = channel.innerHTML + \"<div class=hannel>\";\n"
"    onboot = c.firstElementChild;\n"
"    channel.innerHTML = channel.innerHTML + \"<li>\" + onboot.getAttribute (\"name\") + \"</li>\";\n"
     /* channel source */
"    var source = c.getElementsByTagName (\"source\")[0];\n"
"    channel.innerHTML = channel.innerHTML + \"<ul>Source</ul>\";\n"
"    var v1 = source.getElementsByTagName (\"var\");\n"
"    for (var i = 0; i < v1.length; i++) {\n"
"        channel.innerHTML = channel.innerHTML + \"<li>\" + v1[i].getAttribute (\"name\") + \":\" + v1[i].textContent + \"</li>\";\n"
"    }\n"
     /* channel encoder */
"    var encoder = c.getElementsByTagName (\"encoder\")[0];\n"
"    channel.innerHTML = channel.innerHTML + \"<ul>encoders</ul>\";\n"
"    var  e = encoder.firstElementChild;\n"
"    do {\n"
"        v1 = e.getElementsByTagName (\"var\");\n"
"        channel.innerHTML = channel.innerHTML + \"<ul>encoder</ul>\";\n"
"        for (var i = 0; i < v1.length; i++) {\n"
"            channel.innerHTML = channel.innerHTML + \"<li>\" + v1[i].getAttribute (\"name\") + \":\" + v1[i].textContent + \"</li>\";\n"
"        }\n"
